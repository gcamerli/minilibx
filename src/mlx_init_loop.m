...
{
	((t_mlx_ptr *)info)->loop_hook(((t_mlx_ptr *)info)->loop_hook_data);
}

void	do_loop_flush(CFRunLoopObserverRef observer,
		CFRunLoopActivity activity, void * info)
{
	t_mlx_ptr	*mlx_ptr;
	t_mlx_win_list *win;

	mlx_ptr = (t_mlx_ptr *)info;
...
void mlx_loop(t_mlx_ptr *mlx_ptr)
{
...
void mlx_pixel_put(t_mlx_ptr *mlx_ptr, t_mlx_win_list *win_ptr, int x, int y, int color)
{
	if (!win_ptr->pixmgt)
		return ;
...
int mlx_loop_hook(t_mlx_ptr *mlx_ptr, void (*fct)(void *), void *param)
{
