...
void    *mlx_new_image(t_mlx_ptr *mlx_ptr, int width, int height)
{
...
t_mlx_img_ctx	*add_img_to_ctx(t_mlx_img_list *img, t_mlx_win_list *win)
{
...
void    mlx_put_image_to_window(t_mlx_ptr *mlx_ptr, t_mlx_win_list *win_ptr, t_mlx_img_list *img_ptr, int x, int y)
{
	t_mlx_img_ctx	*imgctx;
...
unsigned int    mlx_get_color_value(t_mlx_ptr *mlx_ptr, int color)
{
	return (color);
}

int mlx_string_put(t_mlx_ptr *mlx_ptr, t_mlx_win_list *win_ptr, int x, int y, int color, unsigned char *string)
{
	t_mlx_img_ctx	*imgctx;
	int		gX;
	int		gY;
...
int     mlx_destroy_image(t_mlx_ptr *mlx_ptr, t_mlx_img_list *img_todel)
{
	t_mlx_img_ctx	ctx_first;
	t_mlx_img_ctx	*ctx;
	t_mlx_img_ctx	*ctx_to_del;
