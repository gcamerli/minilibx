...
void *mlx_new_window(t_mlx_ptr *mlx_ptr, int size_x, int size_y, char *title)
{
	t_mlx_win_list	*newwin;
	NSString		*str;
...
void mlx_clear_window(t_mlx_ptr *mlx_ptr, t_mlx_win_list *win_ptr)
{
...
void mlx_expose_hook(t_mlx_win_list *win_ptr, int (*funct_ptr)(), void *param)
{
	[(id)(win_ptr->winid) setEvent:12 andFunc:funct_ptr andParam:param];
}

void mlx_key_hook(t_mlx_win_list *win_ptr, int (*funct_ptr)(), void *param)
{
	[(id)(win_ptr->winid) setEvent:3 andFunc:funct_ptr andParam:param];
}

void mlx_mouse_hook(t_mlx_win_list *win_ptr, int (*funct_ptr)(), void *param)
{
	[(id)(win_ptr->winid) setEvent:4 andFunc:funct_ptr andParam:param];
}

void mlx_hook(t_mlx_win_list *win_ptr, int x_event, int x_mask, int (*funct_ptr)(), void *param)
{
	[(id)(win_ptr->winid) setEvent:x_event andFunc:funct_ptr andParam:param];
}

int     mlx_do_key_autorepeatoff(t_mlx_ptr *mlx_ptr)
{
	t_mlx_win_list *win;
...
int     mlx_do_key_autorepeaton(t_mlx_ptr *mlx_ptr)
{
	t_mlx_win_list *win;
...
int     mlx_destroy_window(t_mlx_ptr *mlx_ptr, t_mlx_win_list *win_to_del)
{
	t_mlx_win_list    first;
	t_mlx_win_list    *win;
	t_mlx_img_ctx	    *ctx;
	t_mlx_img_ctx	    *ctx2;
