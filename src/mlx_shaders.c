...
/*   Updated: 2018/04/26 16:36:48 by gicamerl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int mlx_shaders_pixel(t_glsl_info *glsl)
{
	char  *source;
	int	length;
	GLint action_ok;
...
int mlx_shaders_image(t_glsl_info	*glsl)
{
	char  *source;
	int	length;
	GLint action_ok;
...
int	mlx_shaders_font(t_glsl_info *glsl)
{
	char  *source;
	int	length;
	GLint action_ok;
